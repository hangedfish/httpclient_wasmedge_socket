static struct fetcherr ftp_errlist[] = {
        ...
        {202, FETCH_PROTO,   "Command not implemented, FETCH_superfluous at this site"},
        {211, FETCH_INFO,    "System status, FETCH_or system help reply"},
        ...
        {250, FETCH_OK,      "Requested file action okay, FETCH_completed"},
